...
test_that("plot_climate_graph works when 1 month > 100 mm precip", {
  ...
  vdiffr::expect_doppelganger("Climate Diagram 1 Month Wet", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
...
test_that("plot_climate_graph works when 0 month > 100 mm precip", {
  ...
  vdiffr::expect_doppelganger("Climate Diagram 0 Month Wet", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
...
test_that("plot_climate_graph works when 2 non-contiguous months > 100 mm precip", {
  ...
  vdiffr::expect_doppelganger("Climate Diagram 2 Non-Contiguous Months Wet", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
...
test_that("plot_climate_graph works when 2 contiguous months > 100 mm precip", {
  ...
  vdiffr::expect_doppelganger("Climate Diagram 2 Contiguous Months Wet", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
...
test_that("plot_climate_graph works when 3 months > 100 mm precip", {
  ...
  vdiffr::expect_doppelganger("Climate Diagram 3 Months Wet", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
...
test_that("plot_climate_graph works when January & December > 100 mm precip", {
  ...
  vdiffr::expect_doppelganger("Climate Diagram Jan and Dec Wet", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
...
test_that("plot_climate_graph works when January & December are freeze periods", {
  ...
  precip <- c(93.1, 62.1, 58.8, 46.6, 45.9, 23.1, 11.2, 18.9, 73.8, 68, 155.3, 76.3)
  vdiffr::expect_doppelganger("Climate Diagram Jan and Dec Freeze", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
...
test_that("plot_climate_graph works when January & February are freeze periods", {
  ...
  precip <- c(93.1, 62.1, 58.8, 46.6, 45.9, 23.1, 11.2, 18.9, 73.8, 68, 155.3, 76.3)
  vdiffr::expect_doppelganger("Climate Diagram Jan and Feb Freeze", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
...
test_that("plot_climate_graph works when January & December are dry periods", {
  ...
  vdiffr::expect_doppelganger("Climate Diagram Jan and Dec Dry", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
...
test_that("plot_climate_graph works when all months are dry", {
  ...
  vdiffr::expect_doppelganger("Climate Diagram All Months Dry", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})

test_that("plot_climate_graph works when all months are humid", {
  temp <- c(22, 22, 23, 25, 27, 28, 31, 31, 27, 23, 22, 19)
  precip <- c(50, 56, 60, 70, 80, 85, 70, 75, 79, 83, 82, 91)
  vdiffr::expect_doppelganger("Climate Diagram All Months Humid", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})

test_that("plot_climate_graph works when all months are wet", {
  temp <- c(22, 22, 23, 25, 27, 28, 31, 31, 27, 23, 22, 19)
  precip <- c(150, 156, 160, 170, 180, 185, 170, 175, 179, 183, 182, 191)
  vdiffr::expect_doppelganger("Climate Diagram All Months Wet", create_climate_diagram(temp = temp, precip = precip,  elev = 25))
})
