...
- Added function `dem_to_table()` for converting a digital elevation model into a data table for climr input
- Improved functionality in `legend_ramp()`, allowing for placement in any type of plot.
