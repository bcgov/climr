...
#'
#'
#' @param X  A `data.table` object that contains the change in temperature relative to the average and the corresping years
#' @param mode  character string in warming_stripes, labelled_stripes, bars
#' 
#'
