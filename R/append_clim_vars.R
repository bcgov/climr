...
.calc_def <- list(
  ...
  "PPT"        = function(v) {v("PPT_wt") + v("PPT_sp") + v("PPT_sm") + v("PPT_at")},
  "Tmax"       = function(v) {(v("Tmax_wt") + v("Tmax_sp") + v("Tmax_sm") + v("Tmax_at")) / 4},
  "Tmin"       = function(v) {(v("Tmin_wt") + v("Tmin_sp") + v("Tmin_sm") + v("Tmin_at")) / 4},
  ...
  "CMI"        = function(v) {(v("PPT") - (v("PET_01") + v("PET_02") + v("PET_03") + v("PET_04") + v("PET_05") + v("PET_06") + v("PET_07") + v("PET_08") + v("PET_09") + v("PET_10") + v("PET_11") + v("PET_12"))) / 10},
  ...
  "Tave"       = function(v) {(v("Tave_wt") + v("Tave_sp") + v("Tave_sm") + v("Tave_at")) / 4},
  "NFFD"       = function(v) {v("NFFD_wt") + v("NFFD_sp") + v("NFFD_sm") + v("NFFD_at")},
  "PAS"        = function(v) {v("PAS_wt") + v("PAS_sp") + v("PAS_sm") + v("PAS_at")},
  "RH"         = function(v) {calc_RH(v("Tmin"), v("Tmax"))},
  "Eref"       = function(v) {v("Eref_wt") + v("Eref_sp") + v("Eref_sm") + v("Eref_at")},
  "CMD"        = function(v) {v("CMD_wt") + v("CMD_sp") + v("CMD_sm") + v("CMD_at")},
  "DDsub0"     = function(v) {v("DDsub0_wt") + v("DDsub0_sp") + v("DDsub0_sm") + v("DDsub0_at")},
  "DDsub18"    = function(v) {v("DDsub18_wt") + v("DDsub18_sp") + v("DDsub18_sm") + v("DDsub18_at")},
  "DD5"        = function(v) {v("DD5_wt") + v("DD5_sp") + v("DD5_sm") + v("DD5_at")},
  "DD18"       = function(v) {v("DD18_wt") + v("DD18_sp") + v("DD18_sm") + v("DD18_at")},
