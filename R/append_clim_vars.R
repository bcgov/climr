...
append_clim_vars <- function(dt, vars) {
  ...
  appenders <- list(
    ...
    "PET01" = function() {set(dt, j = "PET01", value = calc_PET(v("Tave01"),v("Tmin01"),v("Tmax01"),v("Elev")))},
    "PET02" = function() {set(dt, j = "PET02", value = calc_PET(v("Tave02"),v("Tmin02"),v("Tmax02"),v("Elev")))},
    "PET03" = function() {set(dt, j = "PET03", value = calc_PET(v("Tave03"),v("Tmin03"),v("Tmax03"),v("Elev")))},
    "PET04" = function() {set(dt, j = "PET04", value = calc_PET(v("Tave04"),v("Tmin04"),v("Tmax04"),v("Elev")))},
    "PET05" = function() {set(dt, j = "PET05", value = calc_PET(v("Tave05"),v("Tmin05"),v("Tmax05"),v("Elev")))},
    "PET06" = function() {set(dt, j = "PET06", value = calc_PET(v("Tave06"),v("Tmin06"),v("Tmax06"),v("Elev")))},
    "PET07" = function() {set(dt, j = "PET07", value = calc_PET(v("Tave07"),v("Tmin07"),v("Tmax07"),v("Elev")))},
    "PET08" = function() {set(dt, j = "PET08", value = calc_PET(v("Tave08"),v("Tmin08"),v("Tmax08"),v("Elev")))},
    "PET09" = function() {set(dt, j = "PET09", value = calc_PET(v("Tave09"),v("Tmin09"),v("Tmax09"),v("Elev")))},
    "PET10" = function() {set(dt, j = "PET10", value = calc_PET(v("Tave10"),v("Tmin10"),v("Tmax10"),v("Elev")))},
    "PET11" = function() {set(dt, j = "PET11", value = calc_PET(v("Tave11"),v("Tmin11"),v("Tmax11"),v("Elev")))},
    "PET12" = function() {set(dt, j = "PET12", value = calc_PET(v("Tave12"),v("Tmin12"),v("Tmax12"),v("Elev")))},
    
    "CMI" = function() {set(dt, j = "CMI", value = v("PPT") - (v("PET01") + v("PET02") + v("PET03") + v("PET04") + v("PET05") + v("PET06") + v("PET07") + v("PET08") + v("PET09") + v("PET10") + v("PET11") + v("PET12")))},
    ...
    "PAS01" = function() {set(dt, j = "PAS01", value = calc_PAS( 1, v("Tmin01"), v("PPT01")))},
    "PAS02" = function() {set(dt, j = "PAS02", value = calc_PAS( 2, v("Tmin02"), v("PPT02")))},
    "PAS03" = function() {set(dt, j = "PAS03", value = calc_PAS( 3, v("Tmin03"), v("PPT03")))},
    "PAS04" = function() {set(dt, j = "PAS04", value = calc_PAS( 4, v("Tmin04"), v("PPT04")))},
    "PAS05" = function() {set(dt, j = "PAS05", value = calc_PAS( 5, v("Tmin05"), v("PPT05")))},
    "PAS06" = function() {set(dt, j = "PAS06", value = calc_PAS( 6, v("Tmin06"), v("PPT06")))},
    "PAS07" = function() {set(dt, j = "PAS07", value = calc_PAS( 7, v("Tmin07"), v("PPT07")))},
    "PAS08" = function() {set(dt, j = "PAS08", value = calc_PAS( 8, v("Tmin08"), v("PPT08")))},
    "PAS09" = function() {set(dt, j = "PAS09", value = calc_PAS( 9, v("Tmin09"), v("PPT09")))},
    "PAS10" = function() {set(dt, j = "PAS10", value = calc_PAS(10, v("Tmin10"), v("PPT10")))},
    ...
    "DD5_01" = function() {set(dt, j = "DD5_01", value = calc_DD_above_5( 1, v("Tave01"), "West"))},
    "DD5_02" = function() {set(dt, j = "DD5_02", value = calc_DD_above_5( 2, v("Tave02"), "West"))},
    "DD5_03" = function() {set(dt, j = "DD5_03", value = calc_DD_above_5( 3, v("Tave03"), "West"))},
    "DD5_04" = function() {set(dt, j = "DD5_04", value = calc_DD_above_5( 4, v("Tave04"), "West"))},
    "DD5_05" = function() {set(dt, j = "DD5_05", value = calc_DD_above_5( 5, v("Tave05"), "West"))},
    "DD5_06" = function() {set(dt, j = "DD5_06", value = calc_DD_above_5( 6, v("Tave06"), "West"))},
    "DD5_07" = function() {set(dt, j = "DD5_07", value = calc_DD_above_5( 7, v("Tave07"), "West"))},
    "DD5_08" = function() {set(dt, j = "DD5_08", value = calc_DD_above_5( 8, v("Tave08"), "West"))},
    "DD5_09" = function() {set(dt, j = "DD5_09", value = calc_DD_above_5( 9, v("Tave09"), "West"))},
    "DD5_10" = function() {set(dt, j = "DD5_10", value = calc_DD_above_5(10, v("Tave10"), "West"))},
    "DD5_11" = function() {set(dt, j = "DD5_11", value = calc_DD_above_5(11, v("Tave11"), "West"))},
    "DD5_12" = function() {set(dt, j = "DD5_12", value = calc_DD_above_5(12, v("Tave12"), "West"))},
    ...
    "AHM" = function() {set(dt, j = "AHM", value = (v("MAT")+10L)/(v("MAP")/1000L))},
