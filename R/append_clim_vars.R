...
append_clim_vars <- function(dt, vars) {
  ...
  appenders <- list(
    ...
    "CMI01" = function() {set(dt, j = "CMI01", value = calc_CMI(v("PPT01"),v("Tave01"),v("Tmin01"),v("Tmax01"),v("Elev")))},
    "CMI02" = function() {set(dt, j = "CMI02", value = calc_CMI(v("PPT02"),v("Tave02"),v("Tmin02"),v("Tmax02"),v("Elev")))},
    "CMI03" = function() {set(dt, j = "CMI03", value = calc_CMI(v("PPT03"),v("Tave03"),v("Tmin03"),v("Tmax03"),v("Elev")))},
    "CMI04" = function() {set(dt, j = "CMI04", value = calc_CMI(v("PPT04"),v("Tave04"),v("Tmin04"),v("Tmax04"),v("Elev")))},
    "CMI05" = function() {set(dt, j = "CMI05", value = calc_CMI(v("PPT05"),v("Tave05"),v("Tmin05"),v("Tmax05"),v("Elev")))},
    "CMI06" = function() {set(dt, j = "CMI06", value = calc_CMI(v("PPT06"),v("Tave06"),v("Tmin06"),v("Tmax06"),v("Elev")))},
    "CMI07" = function() {set(dt, j = "CMI07", value = calc_CMI(v("PPT07"),v("Tave07"),v("Tmin07"),v("Tmax07"),v("Elev")))},
    "CMI08" = function() {set(dt, j = "CMI08", value = calc_CMI(v("PPT08"),v("Tave08"),v("Tmin08"),v("Tmax08"),v("Elev")))},
    "CMI09" = function() {set(dt, j = "CMI09", value = calc_CMI(v("PPT09"),v("Tave09"),v("Tmin09"),v("Tmax09"),v("Elev")))},
    "CMI10" = function() {set(dt, j = "CMI10", value = calc_CMI(v("PPT10"),v("Tave10"),v("Tmin10"),v("Tmax10"),v("Elev")))},
    "CMI11" = function() {set(dt, j = "CMI11", value = calc_CMI(v("PPT11"),v("Tave11"),v("Tmin11"),v("Tmax11"),v("Elev")))},
    "CMI12" = function() {set(dt, j = "CMI12", value = calc_CMI(v("PPT12"),v("Tave12"),v("Tmin12"),v("Tmax12"),v("Elev")))},
