...
```{r figures-side, fig.cap = "*1961-1990 July T~max~ in the 800m reference clmate map (left) and elevation-adjusted to a 90m grid (right).*", fig.show="hold", out.width="50%"}
