...
<!-- TODO: Colin, please improve the plots as you see fit. I usually avoid showing two variables in different y axes, but wanted to reduce the no. of figures in this case-->
```{r, include = FALSE}
...
ds_out_ts2
## HERE: need different groups for each variable.
yrbreaks <- c(
