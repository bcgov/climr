...
`climr_downscale` has the option to provide outputs in the form of `SpatVector`
of points and map the values of a chosen climate variable from the list passed to 
