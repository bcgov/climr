...
output: 
  rmarkdown::html_vignette:
    ...
    toc_depth: 2
description: >
  Learn the most common `climr` workflows.
vignette: >
...
ahccd_pstations <- mask(ahccd_pstations, vancouver_poly)

## convert to data.table and subset/rename columns needed by climr
xyzDT <- as.data.table(ahccd_pstations, geom = "XY")
cols <- c("stnid", "x", "y", "elev (m)")
xyzDT <- xyzDT[, ..cols]
...
BECz_points <- extract(BECz_vancouver, ahccd_pstations) |>
  as.data.table()
