...
```{r}
hist_proj <- gcm_hist_input(dbCon,
  bbox = the_bb,
  gcm = "EC-Earth3",
  years = 2001:2020,
  max_run = 0
...
fut_proj_ts <- gcm_ts_input(dbCon,
  bbox = the_bb,
  gcm = "EC-Earth3",
  ssp = "ssp245",
  years = 2021:2040,
...
hist_obs <- historic_input(dbCon,
  bbox = the_bb,
  period = "2001_2020"
)
hist_obs_ts <- historic_input_ts(dbCon,
  bbox = the_bb,
  years = 2001:2020
)
```
...
minmax <- range(
  minmax(hist_obs_ts[[1]][["Tmax_07_2001"]]),
...
par(mfrow = c(1, 4))
plot(hist_obs_ts[[1]][["Tmax_07_2001"]],
