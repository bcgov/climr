...
We pass our choices to `downscale()`, choosing the "auto" normals
...
ds_out_ts <- downscale(
  ...
  gcm_hist_years = 2001:2014, ## currently up to 2010
  gcm_ssp_years = 2015:2040, ## currently starting at 2021
  gcms = "EC-Earth3",
  ssps = "ssp245",
  max_run = 1,
  return_refperiod = TRUE, ## to return the 1961-1990 normals period
